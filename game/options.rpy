...
define config.name = "DDLC: The Trolling Russia the Definitive Edition"
...
define build.name = "DDLCTrollingRussiaDefinitiveEdition"
...
# main menu.
define config.main_menu_music = audio.ugotthat
...
#   Linux: $HOME/.renpy/
define config.save_directory = "DDLCTrollingRussiaDefinitiveEdition"
